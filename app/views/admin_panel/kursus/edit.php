...
<div class="container container-sm form-crud">
  <div class="card">
    <div class="card-body">
      <form action="<?= BASEURL; ?>/kursus/update" method="POST">
        ...
        <div class="mb-3">
          ...
          <select class="form-control" id="selectKategori" name="id_kategori">
            ...
            <?php foreach ($kategori as $row) : ?>
              <option value="<?= $row['id']; ?>" <?= $kursus['id_kategori'] === $row['id'] ? 'selected' : '' ?>><?= $row['nama']; ?></option>
            <?php endforeach; ?>
          </select>
        ...
        <div class="mb-3">
          ...
          <select class="form-control" id="selectPengguna" name="id_pengguna">
            ...
            <?php foreach ($pengguna as $row) : ?>
              <option value="<?= $row['id']; ?>" <?= $kursus['id_pengguna'] === $row['id'] ? 'selected' : '' ?>><?= $row['nama']; ?></option>
            <?php endforeach; ?>
          </select>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="nama" id="nama" placeholder="Masukkan nama" value="<?= $kursus['nama']; ?>">
        ...
        <div class="mb-3">
          ...
          <input type="number" min="0" class="form-control" name="total_jam_belajar" id="total_jam_belajar" placeholder="Masukkan lama waktu belajar" value="<?= $kursus['total_jam_belajar']; ?>">
        ...
        <div class="mb-3">
          ...
          <input type="number" min="0" class="form-control" name="harga" id="harga" placeholder="Masukkan harga" value="<?= $kursus['harga']; ?>">
        ...
        <div class="mb-3">
          ...
          <input type="number" min="0" max="5" class="form-control" name="rating" id="rating" placeholder="Masukkan rating pengguna" value="<?= $kursus['rating']; ?>">
        ...
        <div class="mb-3">
          ...
          <textarea name="deskripsi" id="deskripsi" cols="10" rows="5" class="form-control" placeholder="Masukkan deskripsi"><?= $kursus['deskripsi']; ?></textarea>
