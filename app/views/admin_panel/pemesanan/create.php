    ...
    <div class="card-body">
      <form action="<?= BASEURL; ?>/pemesanan/store" method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="id_kursus" id="id_kursus" placeholder="Masukkan id kursus">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="tanggal_pesan" id="tanggal_pesan" placeholder="Masukkan tanggal pesan">
